...
public:
    ...
    static const QStringList SQL_MODE;
    static const QStringList BUSY_LOCK;
    static const QStringList PTT_ID;
    ...
    static const QStringList KEY_FUNCTION_D878UVII;
    static const QStringList KEY_FUNCTION_D890UV;
    ...
    static const QStringList SCRAMBLER;
    static const QStringList CUSTOM_SCRAMBLER;
